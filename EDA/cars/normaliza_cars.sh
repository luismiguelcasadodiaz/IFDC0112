...
# tail -n+2 cars04.csv | cut -d\; -f5,3 --output-delimiter=","|sort|uniq > cars_postal_codes.csv  # cuidado que es una relacion muchos a muchos No 
tail -n+2 cars04.csv | cut -d\; -f5,3 --output-delimiter=","|sort|uniq|sort -d"," -k2 > cars_postal_codes.csv  # cuidado que es una relacion muchos a muchos. Se ve al ordenar por codigo.
